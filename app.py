...
function uploadFile() {
    ...
    .then(data => {
        ...
        // RESULT TEXT
        if (data.prediction === "Fight") {
            document.getElementById("result").innerHTML =
                "<span style='color:red'>🚨 Fight Detected</span><br>" +
                "Confidence: " + data.confidence +
                "<br>Max Intensity: " + data.max_intensity;
        } else {
            document.getElementById("result").innerHTML =
                "<span style='color:lightgreen'>✅ No Fight</span><br>" +
                "Confidence: " + data.confidence +
                "<br>Max Intensity: " + data.max_intensity;
        }
        ...
        let labels = data.intensity_data.map((_, i) => "Frame " + (i + 1));
        ...
        // 🔥 ANIMATION (draw line gradually)
        let i = 0;
        let interval = setInterval(() => {
            if (i >= data.intensity_data.length) {
